...
namespace Facware.Base.Api.Extensions.Database
{
    public static class DatabaseExtension
    {
        ...
        public static void UsePostgreSqlServer(this IServiceCollection serviceCollection, string applicationConfigurationConnectionString)
        {
            ...
            serviceCollection.AddDbContext<FacwareBaseContext>(options => options.UseNpgsql(applicationConfigurationConnectionString));
        }
    }
}
